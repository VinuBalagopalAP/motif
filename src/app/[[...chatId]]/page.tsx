    ...
    <div className="flex h-[100dvh] bg-[#ffffff] text-[#282828] font-sans selection:bg-[#c3f3b9]">
      ...
      <div className="flex-1 flex min-w-0 relative bg-[#ffffff] overflow-hidden">
        ...
        <div className={`flex flex-col min-w-0 h-full relative transition-all duration-300 ease-in-out ${activeArtifact ? 'w-full md:w-[400px] border-r border-gray-100 hidden md:flex flex-shrink-0' : 'w-full flex-1'}`}>
          ...
          <main id="chat-main" className="flex-1 overflow-y-auto p-4 sm:p-6">
                            ...
                            {m.job?.status === 'done' && activeRenderSpec ? (
                              <div className="mt-2 flex flex-col items-center gap-4 w-full max-w-[320px]">
                                ...
                                {m.variants && m.variants.length > 1 && (
                                  <div className="flex items-center justify-center gap-3 w-full my-2 text-xs font-semibold text-gray-500">
                                    <button
        ...
        {/* Canvas Pane */}
        {activeArtifact && (
          <div className="flex-1 hidden md:flex flex-col bg-white border-l border-gray-100 h-full overflow-hidden animate-in slide-in-from-right-8 duration-300">
            <header className="h-[57px] flex-shrink-0 border-b border-gray-100 flex items-center justify-between px-4">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-500 border border-gray-100 flex-shrink-0">
                  {activeArtifact.type === 'code' || activeArtifact.type === 'react' ? (
                ...
                <div className="truncate">
                  <h2 className="text-sm font-bold text-[#282828] truncate">{activeArtifact.title}</h2>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto bg-[#1e1e1e]">
              {activeArtifact.type === 'code' || activeArtifact.type === 'react' ? (
                ...
                <div className="p-8 prose prose-invert max-w-none text-gray-200">
